...
<head>
    ...
    <link href="/static/admin/css/userManagement/lampPermission.css" rel="stylesheet">
</head>
<body>
...
<script src="/static/admin/js/userManagement/lampPermission.js"></script>
<script type="text/html" id="tool">
    <a class="layui-btn layui-btn-primary layui-btn-xs" lay-event="tooleAction">授权</a>
</script>
</html>