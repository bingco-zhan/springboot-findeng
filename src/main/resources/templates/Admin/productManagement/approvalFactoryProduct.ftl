...
<head>
    <meta charset="UTF-8">
    <title>审批厂家产品界面</title>
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
    <link href="/public/layui/css/layui.css" rel="stylesheet">
    <link href="/static/admin/css/productManagement/approvalFactoryProduct.css" rel="stylesheet"/>
</head>
<body>
...
<script src="/static/admin/js/productManagement/approvalFactoryProduct.js"></script>
</html>
