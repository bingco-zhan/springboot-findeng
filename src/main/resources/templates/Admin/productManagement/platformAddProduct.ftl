...
<head>
    <meta charset="UTF-8">
    <title>平台添加商品界面</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link href="/public/layui/css/layui.css" rel="stylesheet">
    <link href="/static/admin/css/productManagement/platformAddProduct.css" rel="stylesheet"/>
</head>
<body>
<div class="layui-fluid" style="margin-top: 10px;">
    <form class="layui-form layui-form-pane" action="/admin/api/certificationApplication" method="post"
          onsubmit="onsubmit();" id="factoryAddproductForm">
        ...
        <div class="layui-row">
            ...
            <div class="layui-col-md4 layui-col-sm6">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <select name="productSeriesId" lay-verify="productSeriesId">
            ...
            <div class="layui-col-md4 layui-col-sm6">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <select name="productBrand" lay-verify="productBrand">
                            <option value="">请选择产品品牌</option>
                            <#list productBrandList as productBrand>
                                <option value="${productBrand[2]}">${productBrand[2]}</option>
                            </#list>
                        </select>
                    </div>
                </div>
                ...
                <div class="layui-col-md3 layui-col-sm4">
                    <div class="prview-content">
                        <div class="layui-form-item prview-item">
                            ...
                            <input lay-verify="descriptionPic" name="descriptionPic" type="hidden">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="layui-col-md3 layui-col-sm4">
                <div class="prview-content">
                    <div class="layui-form-item prview-item">
                        ...
                        <input lay-verify="productSpreadPic" name="productSpreadPic" type="hidden">
                    </div>
                </div>
            </div>
            <div class="layui-col-md1 layui-col-sm1">
            ...
            <div class="layui-col-md3 layui-col-sm4">
                <div class="prview-content">
                    <div class="layui-form-item prview-item">
                        ...
                        <input lay-verify="threeCCertification" name="threeCCertification" type="hidden">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="layui-col-md6 layui-col-sm6">
                ...
                <div class="layui-col-md6 layui-col-sm6">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="originUnitPrice" required lay-verify="originUnitPrice"
                ...
                <div class="layui-col-md6 layui-col-sm6">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="lightNumber" required lay-verify="lightNumber"
                ...
                <div class="layui-col-md12 layui-col-sm12">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="radio" name="hasLightSource" value="1" title="有" checked>
                            <input type="radio" name="hasLightSource" value="0" title="无">
                        </div>
                    </div>
                </div>
                <div class="layui-col-md6 layui-col-sm6">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="productStock" required lay-verify="productStock"
                ...
                <div class="layui-col-md6 layui-col-sm6">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="productPower" required lay-verify="productPower"
                ...
                <div class="layui-col-md6 layui-col-sm6">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="qualityGuaranteeTime" required lay-verify="qualityGuaranteeTime"
                                   placeholder="请输入保质期" class="layui-input">
                        </div>
                    </div>
                </div>
                <div class="layui-col-md6 layui-col-sm6">
                ...
                <div class="layui-col-md6 layui-col-sm6">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="lightColor" required lay-verify="lightColor" placeholder="请输入光色"
                                   class="layui-input">
                        </div>
                    </div>
                </div>
                ...
                <div class="layui-col-md6 layui-col-sm6">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="number" name="productLength" required lay-verify="productLength"
                ...
                <div class="layui-col-md6 layui-col-sm6">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="number" name="productWidth" required lay-verify="productWidth"
                ...
                <div class="layui-col-md6 layui-col-sm6">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="number" name="productHeight" required lay-verify="productHeight"
                ...
                <div class="layui-col-md6 layui-col-sm6">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="number" name="productDiameter" required lay-verify="productDiameter"
                ...
                <div class="layui-col-md6 layui-col-sm6">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="number" name="productFromthewall" required lay-verify="productFromthewall"
                ...
                <div class="layui-col-md6 layui-col-sm6">
                    <div class="layui-form-item">
                        <label class="layui-form-label">产品净重(kg)</label>
                        <div class="layui-input-block">
                            <input type="number" name="productWeight" required lay-verify="productWeight"
                                   placeholder="请输入产品净重" class="layui-input">
                        </div>
                    </div>
                </div>
                <div class="layui-col-md12 layui-col-sm12">
        ...
        <!-- 表单提交按钮 -->
        <div class="layui-row">
            <div class="layui-col-md-offset8 layui-col-sd-offset8">
                <div class="layui-form-item">
                    <div class="layui-input-block">
                        <button class="layui-btn factoryAddproductForm-subtim" lay-submit
                                lay-filter="formFactoryAddproduct">立即提交
                        </button>
...
<script type="text/javascript" src="/static/admin/js/productManagement/platformAddProduct.js"></script>
</html>