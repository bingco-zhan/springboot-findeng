...
<head>
    <meta charset="UTF-8">
    <title>供应商商品列表界面</title>
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
    <link href="/public/layui/css/layui.css" rel="stylesheet">
    <link href="/static/admin/css/productManagement/factoryProductList.css" rel="stylesheet"/>
</head>
<body>
...
<script src="/static/admin/js/productManagement/factoryProductList.js"></script>
</html>
...
<script>
    var productSeriesListJSON = ${productSeriesListJSON!"[]"}
</script>