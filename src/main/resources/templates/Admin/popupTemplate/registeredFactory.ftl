...
<div class="layui-fluid" style="margin-top: 10px;">
    <form class="layui-form layui-form-pane" action="/admin/api/certificationApplication" method="post"
          onsubmit="onsubmit();" id="registeredFactoryForm">
            ...
            <div class="layui-col-md6 layui-col-sm6">
                <div class="prview-content">
                    <div class="layui-form-item prview-item">
                        ...
                        <input lay-verify="logoPic" name="logoPic" type="hidden">
                    </div>
                </div>
            </div>
        </div>
        <div class="layui-col-md12 layui-col-sm12" style="display:none;">
            <div class="layui-form-item">
                <div class="layui-input-block">
                    <button class="layui-btn registeredFactoryForm-subtim" lay-submit lay-filter="formFactory">立即提交
                    </button>
...
<script>
    //表单提交方法
    form.on('submit(formFactory)', function (data) {
